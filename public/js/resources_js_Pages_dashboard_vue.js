...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    editLead: function editLead() {
      ...
      if (this.$store.state.dashboard.modifyinleadcolID == -1) this.$store.state.dashboard.modifyinleadcolID = this.col_index;else this.$store.state.dashboard.modifyinleadcolID = -1;
      console.log(this.$store.state.dashboard.modifyinleadcolID);
      if (this.$store.state.dashboard.modifyingleadID == -1) this.$store.state.dashboard.modifyingleadID = this.index;else this.$store.state.dashboard.modifyingleadID = -1;
    },
    ...
    onDrop1: function onDrop1(evt, lead, ident) {
      var itemID = evt.dataTransfer.getData('itemID');
      var boardID = evt.dataTransfer.getData('boardID'); // const leadIndex = evt.dataTransfer.getData('leadIndex')
    ...
    loadFhstyles: function loadFhstyles() {
      try {
        if (this.$store.state.dashboard.loaded) return {
  ...
  mounted: function mounted() {
    this.$nextTick(function () {
      this.$store.state.dashboard.loaded = true; // For invoking property from child element
      ...
      [
        _c(
          "div",
          {
            ...
            attrs: { draggable: !this.dashboard.isdraggable },
            on: {
          ...
          [
            _c("textarea", {
              ref: "boardtitle",
              class: { "is-editing": this.$store.state.dashboard.isediting },
              attrs: {
                name: "",
                id: "",
                "aria-label": "grgr",
                readonly: this.$store.state.dashboard.isediting
              },
        ...
        _c("div", { staticClass: "boardnav" }, [
          this.dashboard.modifyinleadcolID == _vm.col_index
            ? _c(
                "div",
                {
                  class: { newleadcontent: this.dashboard.leadadding },
                  attrs: { hidden: "" }
                },
                [
                  _c("textarea", {
...
var render = function() {
  ...
  return _c(
    "div",
    {
      ...
      on: {
        dragstart: function($event) {
          return _vm.startDrag1($event, _vm.lead)
        }
      }
    },
    [
      _vm._v("\n" + _vm._s(_vm.lead.order) + "\n\n  "),
      _c("div", { staticClass: "leads-outer-outline" }, [
        _c("div", [
          _c("div", {
            ...
            on: {
              drop: function($event) {
                return _vm.onDrop1($event, _vm.lead, 0)
              },
          ...
          _c("div", {
            ...
            on: {
              drop: function($event) {
                return _vm.onDrop1($event, _vm.lead, 1)
              },
              dragover: function($event) {
                $event.preventDefault()
              },
      ...
      _c("div", { staticClass: "leads-container" }, [
        this.$store.state.dashboard.modifyingleadID == _vm.index &&
        _vm.col_index == this.$store.state.dashboard.modifyinleadcolID
      ...
      [
        ...
        _c("div", { staticClass: "boards-append" }, [
          _c(
            ...
            {
              class: {
                "boards-append-adding-form": this.$store.state.dashboard
                  .addingboard
              },
              attrs: { hidden: "" }
            },
          ...
          _vm._v(" "),
          !this.dashboard.addingboard
            ? _c(
                "div",
                {
                  staticClass: "boards-append-area",
                  class: {
                    "boards-append-adding-btn": this.dashboard.addingboard
                  },
