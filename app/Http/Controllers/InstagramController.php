...
class InstagramController extends Controller
{
    public function index()
    {
        ...
        $responses = $response->data->user->edge_owner_to_timeline_media->edges;
        ...
        $time = Carbon::createFromTimestamp($responses[6]->node->taken_at_timestamp)->timezone('+06:00')->toDateTimeString();

        return view('instagram.index', compact('responses'));
    }
}
