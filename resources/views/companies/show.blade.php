                    ...
                    <div class="wrapper">
                        <div class="body">
                            ...
                            <div class="single-block single-map">
                                <script src="https://api-maps.yandex.ru/2.1/?lang=ru_RU&apikey=924d50da-b264-47e5-83a8-394475783990" type="text/javascript"></script>
                        ...
                        <div class="sb-header icon-reviews">Отзывы и оценки</div>
                            ...
                            <!-- #comment-## -->
                                ...
                                <div class="item" id="comment-13">
                                    <div class="avatar" style="background-image: url(https://secure.gravatar.com/avatar/e35086937b77462150c8144ce6867e94?s=96&amp;d=identicon&amp;r=g)"></div>
                                        <div class="review-content article">
                                            <div class="top">
                                                <div class="text">
                                                    <h5>{{ $comment->user->last_name . ' ' . $comment->user->first_name }}</h5>
                                            ...
                                            @auth
                                                ...
                                                <form method="POST" action="{{ route('dislike', $comment->id) }}">
                                                    @csrf
                                                    @method('DELETE')
                                                    <div class="bottom btns sb bm">
                                                        <div class="line">
                                            ...
                                            @if ($comment->user_id === Auth::user()->id)
                                                <div class="bottom btns sb bm">
                                                    <div class="line">
                                                        <form action="{{ route('comments.edit', [$comment->id, $company->id]) }}" method="GET">
                                                            @csrf
                        ...
                        <form method="POST" action="{{ route('comments.store', $company) }}">
                            ...
                            <div id="respond" class="comment-respond">
                                ...
                                <p class="comment-form-comment"><label for="comment">Комментарий</label>
                                    <textarea id="comment" name="comment" cols="45" rows="8" maxlength="65525" required="required">{{ old('comment') }}</textarea>
                                </p>
                                @error('comment')
                                    <p>{{ $message }}</p>
                                @enderror
